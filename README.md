...
I created a similar tool two years ago, available in this repository: [Custom Ping Utility](https://github.com/w453y/Custom-Ping-Utility). However, this latest version includes additional features.
